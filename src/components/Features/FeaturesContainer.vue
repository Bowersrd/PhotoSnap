...
const features = ref([
  ...
  },
  {
    ...
    icon: "features/DragDrop",
  },
]);

const visibleFeatures = props.isFeatured
  ? features.value.slice(0, 3)
  : features;
</script>
